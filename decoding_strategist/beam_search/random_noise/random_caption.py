...
def caption_image(encoder, decoder, word_map, beam_size):
    # OOD
    ...
    return beam_search_decode(encoder, image, beam_size, word_map, decoder, vocab_size), img1
...
def run(encoder, decoder, word_map, rev_word_map, save_dir, ind, beam_size):
    (seq, alphas, top_seq_total_scors, seq_sum, logits_list), img = caption_image(encoder,
                                                                                  decoder,
                                                                                  word_map,
                                                                                  beam_size)
