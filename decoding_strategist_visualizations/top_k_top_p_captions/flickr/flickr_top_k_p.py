...
def run(encoder, decoder, word_map, rev_word_map, save_dir, top_k, top_p, image, image_title, image_id):
    ...
    f.write(
        'seq_sum: {}    for image id: {}    with caption: {}\n'.format(sum(top_seq_total_scors), image_id, image_title))
    print('seq_sum: {}'.format(sum(top_seq_total_scors)))
...
if __name__ == '__main__':
    ...
    for ind, image_data in enumerate(dataloader):
        ...
        run(encoder, decoder, word_map, rev_word_map, save_dir, top_k, top_p, image, image_title, image_id)
