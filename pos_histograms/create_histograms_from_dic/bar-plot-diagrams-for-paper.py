...
plt.bar(index+bar_width*5, [0.25, 0.19, 0.1], width=bar_width, color='yellow', label='JPEG comp')
...
ax.get_xaxis().tick_bottom()
ax.get_yaxis().tick_left()
plt.bar(index,[0.32, 0.47, 0.25], width=bar_width, color='pink', label='COCO')
...
plt.bar(index+bar_width*5, [0.28, 0.32, 0.2], width=bar_width, color='yellow', label='JPEG comp')
plt.bar(index+bar_width*6, [0.29, 0.29, 0.21], width=bar_width, color='purple', label='salt-and-pepper')
#plt.legend()
plt.xticks(index + bar_width+bar_width, ('VERB', 'NOUN', 'ADJ'))
plt.xlabel("part of speech", fontsize=10)
plt.ylabel("avg prob", fontsize=10)
...
plt.bar(index+bar_width*5, [0.32, 0.32, 0.32], width=bar_width, color='yellow', label='JPEG comp')
