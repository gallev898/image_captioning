...
if __name__ == '__main__':
    ...
    for i, (image, caps, caplens) in enumerate(tqdm(train_loader)):
        train_caps_lst.append((caps, caplens))
        if args.run_local and i == 5:
            break

    save_dir = '../output_folder/local_train_caps_lst' if args.run_local else '/yoav_stg/gshalev/image_captioning/output_folder/train_caps_lst'
